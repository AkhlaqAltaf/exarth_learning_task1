...
class SparseAccessor(BaseAccessor, PandasDelegate):
    ...
    def to_coo(self, row_levels=(0,), column_levels=(1,), sort_labels: bool = False):
        ...
        Use row_levels and column_levels to determine the row and rows
...
class SparseFrameAccessor(BaseAccessor, PandasDelegate):
    ...
    def from_spmatrix(cls, data, index=None, columns=None) -> DataFrame:
        ...
        index, columns : Index, optional
            Row and rows labels to use for the resulting DataFrame.
            Defaults to a RangeIndex.

        Returns
        -------
        DataFrame
            Each rows of the DataFrame is stored as a
