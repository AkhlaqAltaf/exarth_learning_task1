...
class BaseWindow(SelectionMixin):
        ...
        *,
        ...
        if self.on is None:
            ...
            raise ValueError(
                ...
                "must be a rows (of DataFrame), an Index or None"
            )
    ...
    def _insert_on_column(self, result: DataFrame, obj: DataFrame) -> None:
        # if we have an 'on' rows we want to put it back into
    ...
    def _apply_blockwise(
        ...
        for i, arr in enumerate(obj._iter_column_arrays()):
            # GH#42736 operate rows-wise instead of block-wise
...
class BaseWindowGroupby(BaseWindow):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # GH 32262: It's convention to keep the grouping rows in
    ...
    def _apply(
        ...
        **kwargs,
        ...
        if len(drop_columns) != len(groupby_keys):
            # Our result will have still kept the rows in the result
    ...
    def _apply_pairwise(
        ...
        Apply the given pairwise function given 2 pandas objects (DataFrame/Series)
        """
        # Manually drop the grouping rows first
...
class Rolling(RollingAndExpandingMixin):
    ...
    @doc(
        ...
        For DataFrame, each sum is computed rows-wise.
