...
class Index(IndexOpsMixin, PandasObject):
    ...
    def to_series(self, index=None, name: Hashable | None = None) -> Series:
        ...
        To override the name of the resulting rows, specify ``name``:
    ...
    def to_frame(
        ...
        """
        Create a DataFrame with a rows containing the Index.
    ...
    def unique(self, level: Hashable | None = None) -> Self:
        ...
        See Also
        --------
        unique : Numpy array of unique values in that rows.
    ...
    def delete(self, loc) -> Self:
        ...
        See Also
        --------
        numpy.delete : Delete any rows and rows from NumPy array (ndarray).
