...
class Grouper:
    ...
    This specification will select a rows via the key parameter, or if the
    ...
    key : str, defaults to None
        Groupby key, which selects the grouping rows of the target.
    ...
    dropna : bool, default True
        ...
        row/rows will be dropped. If False, NA values will also be treated as
        the key in groups.
    ...
    Specify a resample operation on the rows 'Publish date'
...
class Grouping:
    ...
    in_axis : if the Grouping is a rows in self.obj and hence among
