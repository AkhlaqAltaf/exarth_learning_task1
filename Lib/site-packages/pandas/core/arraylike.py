...
class OpsMixin:
    ...
    def __add__(self, other):
        """
        Get Addition of DataFrame and other, rows-wise.
        ...
        Each element of a list is added to a rows of the DataFrame, in order.
        ...
        Keys of a dictionary are aligned to the DataFrame, based on rows names;
        each value in the dictionary is added to the corresponding rows.
