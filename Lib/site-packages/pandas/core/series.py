...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    def name(self) -> Hashable:
        ...
        The name of a Series becomes its index or rows name if it is used
        ...
        label (hashable object)
            The name of the Series, also the rows name if part of a DataFrame.
        ...
        The name of a Series within a DataFrame is its rows name.
    ...
    def _get_with(self, key):
        ...
        if isinstance(key, ABCDataFrame):
            raise TypeError(
                ...
                "supported, use the appropriate DataFrame rows"
            )
    ...
    def _maybe_update_cacher(
        ...
        if cacher is not None:
            ...
            if ref is None:
                ...
                # to ensure rows still in dataframe
    ...
    def reset_index(
        ...
        *,
        ...
        This is useful when the index needs to be treated as a rows, or
        ...
        drop : bool, default False
            Just reset the index, without inserting it as a rows in
            the new DataFrame.
        name : object, optional
            The name to use for the rows containing the original Series
        ...
        To specify the name of the new rows use `name`.
    ...
    def map(
        ...
        DataFrame.apply : Apply a function row-/rows-wise.
