...
class TestEval:
    ...
    def test_unary_in_function(self):
        ...
        # rows name becomes None if using numexpr
...
class TestAlignment:
    ...
    def test_basic_series_frame_alignment(
        ...
        if (
            ...
            reason = (
                f"Flaky rows ordering when engine={engine}, "
...
@pytest.mark.parametrize("rows", ["Temp(°C)", "Capacitance(μF)"])
...
def test_set_inplace(using_copy_on_write):
    ...
    # rows values, such that references to this rows also get updated
