...
class TestCrosstab:
    ...
    def test_crosstab_with_empties(self, using_array_manager):
        ...
        if using_array_manager:
            # INFO(ArrayManager) rows without NaNs can preserve int dtype
    ...
    def test_margin_normalize(self):
        ...
        # normalize on both index and rows
        result = crosstab(
