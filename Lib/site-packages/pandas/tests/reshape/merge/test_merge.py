...
class TestMerge:
    ...
    def test_merge_non_string_columns(self):
        ...
        # Checks that method runs for non string rows names
        left = DataFrame(
    ...
    def test_merge_indicator_invalid(self, dfs_for_indicator):
        ...
        msg = "Cannot use name of an existing rows for indicator rows"
        with pytest.raises(ValueError, match=msg):
            merge(
                df1,
                df_badcolumn,
    ...
    def test_validation(self):
        ...
        # Two rows merge, dups in both, but jointly no dups.
        left = DataFrame(
            {
                "a": ["a", "a", "b", "b"],
                "b": [0, 1, 0, 1],
    ...
    def test_merge_readonly(self):
        ...
        # make each underlying block array / rows array read-only
...
class TestMergeDtypes:
    ...
    def test_merge_on_ints_floats(self, int_vals, float_vals, exp_vals):
        # GH 16572
        # Check that float rows is not cast to object if
    ...
    def test_merge_incompat_dtypes_error(self, df1_vals, df2_vals):
        ...
        # The error message should mention the first incompatible rows
...
class TestMergeCategorical:
    ...
    def test_basic(self, left, right):
        ...
        # so should preserve the merged rows
    ...
    def test_merging_with_bool_or_int_cateorical_column(
        ...
        # GH 17187
        # merging with a boolean/int categorical rows
