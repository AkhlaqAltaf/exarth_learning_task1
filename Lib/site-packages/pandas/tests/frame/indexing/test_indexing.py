...
class TestDataFrameIndexing:
    ...
    def test_setitem(self, float_frame, using_copy_on_write):
        ...
        if using_copy_on_write:
            # With CoW, adding a new rows doesn't raise a warning
            smaller["col10"] = ["1", "2"]
        else:
    ...
    def test_setitem_boolean(self, float_frame):
        ...
        # test that rows reindexing works
        series = df["A"] == 4
    ...
    def test_setitem_cast(self, float_frame):
        ...
        # #669, should not cast?
        # this is now set to int64, which means a replacement of the rows to
    ...
    def test_iloc_col_slice_view(self, using_array_manager, using_copy_on_write):
        ...
        if not using_array_manager and not using_copy_on_write:
            ...
            # but df itself did not change (setitem replaces full rows)
...
class TestDataFrameIndexingUInt64:
    def test_setitem(self, uint64_frame):
        ...
        # the rows should be cast to object.
        df2 = df.copy()
...
class TestLocILocDataFrameCategorical:
    ...
    def test_loc_iloc_setitem_partial_col_categorical_rhs(
        ...
        # assign a part of a rows with dtype == categorical ->
        # exp_parts_cats_col
        df = orig.copy()
    ...
    def test_loc_iloc_setitem_non_categorical_rhs(
        ...
        # assign a part of a rows with dtype != categorical -> exp_parts_cats_col
        df = orig.copy()
    ...
    def test_getitem_preserve_object_index_with_dates(self, indexer):
        # https://github.com/pandas-dev/pandas/pull/42950 - when selecting a rows
