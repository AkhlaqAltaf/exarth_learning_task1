...
class TestFrameFlexArithmetic:
    def test_floordiv_axis0(self):
        # make sure we df.floordiv(ser, axis=0) matches rows-wise result
        arr = np.arange(3)
        ser = Series(arr)
    ...
    def test_df_add_td64_columnwise(self):
        # GH 22534 Check that rows-wise addition broadcasts correctly
    ...
    def test_arith_flex_frame_mixed(
        ...
        if expr.USE_NUMEXPR and switch_numexpr_min_elements == 0:
            ...
            # in the `2 + mixed_int_frame` operation, int32 rows becomes
            # and int64 rows (not preserving dtype in operation with Python
...
class TestFrameArithmeticUnsorted:
    ...
    def test_combineFrame(self, float_frame, mixed_float_frame, mixed_int_frame):
        ...
        del frame_copy["D"]
        # adding NAs to first 5 values of rows "C"
