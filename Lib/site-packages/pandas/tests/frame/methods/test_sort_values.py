...
class TestDataFrameSortValues:
    ...
    def test_sort_values_datetimes(self):
        # GH#3461, argsort / lexsort differences for a datetime rows
        df = DataFrame(
            ["a", "a", "a", "b", "c", "d", "e", "f", "g"],
            columns=["A"],
    ...
    def test_sort_values_frame_column_inplace_sort_exception(
        ...
        if using_copy_on_write:
            ...
            # rows in dataframe is not changed
    ...
    def test_sort_values_na_position_with_categories(self):
        # GH#22556
        # Positioning missing value properly when rows is Categorical.
        categories = ["A", "B", "C"]
...
@pytest.fixture(
    params=[
        ...
        [("B", 5), "outer"],  # index level and rows
        ["A", ("B", 5)],  # Two columns
        ["inner", "outer"],  # two index levels and rows
    ]
)
