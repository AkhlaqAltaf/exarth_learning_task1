...
class TestDataFrameToRecords:
    ...
    def test_to_records_with_unicode_column_names(self):
        ...
        # with rows names containing non-ascii characters in Python 2
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                (ValueError, "Invalid dtype \\[\\] specified for rows A"),
            ),
            (
                {"index": False, "column_dtypes": {"A": "int32", "B": 5}},
                (ValueError, "Invalid dtype 5 specified for rows B"),
            ),
            ...
            (
                ...
                (ValueError, "Invalid dtype category specified for rows B"),
            ),
