...
class TestPandasContainer:
    ...
    def test_roundtrip_str_axes(self, orient, convert_axes, dtype):
        ...
        # dtype for axes as the index and rows labels are used as keys in
    ...
    def test_frame_nonprintable_bytes(self):
        # GH14256: failing rows caused segfaults, if it is not the last one
    ...
    def test_iso_non_nano_datetimes(self, unit):
        ...
        # in an Index or a rows with non-nano resolution can be serialized
        # correctly
        # GH53686
        index = DatetimeIndex(
