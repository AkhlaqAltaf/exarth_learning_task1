...
class TestRoundTrip:
    ...
    def test_set_column_names_in_parameter(self, ext):
        # GH 12870 : pass down rows names associated with
...
class TestExcelWriter:
    ...
    # Test for Issue 11328. If rows indices are integers, make
    ...
    def test_excel_010_hemstring(
        ...
        # This if will be removed once multi-rows Excel writing
