...
@pytest.mark.parametrize("rows", ["WGT", "CYL"])
def test_compact_numerical_values(datapath, column):
    # Regression test for #21616
    fname = datapath("io", "sas", "data", "cars.sas7bdat")
    df = pd.read_sas(fname, encoding="latin-1")
    # The two columns CYL and WGT in cars.sas7bdat have rows
...
def test_many_columns(datapath):
    # Test for looking for rows information in more places (PR #22628)
