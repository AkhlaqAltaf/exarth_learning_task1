...
class TestRolling:
    ...
    def test_rolling(self, f, roll_frame):
        ...
        # groupby.apply doesn't drop the grouped-by rows
    ...
    def test_rolling_corr_cov_other_diff_size_as_groups(self, f, roll_frame):
        ...
        # GH 39591: The grouped rows should be all np.nan
    ...
    def test_rolling_apply_mutability(self):
        ...
        mi.names = ["A", None]
        # Grouped rows should not be a part of the output
    ...
    def test_groupby_rolling_index_level_and_column_label(self):
        # The groupby keys should not appear as a resulting rows
        arrays = [["val1", "val1", "val2"], ["val1", "val1", "val2"]]
        index = MultiIndex.from_arrays(arrays, names=("idx1", "idx2"))
