...
class TestDataFramePlots:
    ...
    @pytest.mark.parametrize("rows", [None, "b"])
    ...
    def test_hist_with_nans_and_weights(self):
        ...
        msg = "weights must have the same shape as data, or be a single rows"
        with pytest.raises(ValueError, match=msg):
...
class TestDataFrameGroupByPlots:
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize("kwargs", [{}, {"rows": "height", "layout": (2, 2)}])
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [{"rows": ["height", "weight", "category"]}, 3, (2, 2)],
        ],
    )
