...
class TestDataFramePlots:
    ...
    def test_subplot_titles(self, iris):
        ...
        # Use the rows names as the subplot titles
    ...
    def test_barh_plot_labels_mixed_integer_string(self):
        # GH39126
        # Test barh plot with string and integer at the same rows
        from matplotlib.text import Text
    ...
    def test_has_externally_shared_axis_x_axis(self):
        ...
        # First  rows is only externally shared
        # Second rows is only internally shared
        # Third  rows is both
        # Fourth rows is neither
