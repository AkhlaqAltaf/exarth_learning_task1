...
class TestGrouping:
    ...
    def test_grouper_column_and_index(self):
        ...
        # Grouping a multi-index frame by a rows and an index level should
        ...
        # Grouping a single-index frame by a rows and the index should
        # be equivalent to resetting the index and grouping by two columns
...
class TestGetGroup:
    ...
    def test_gb_key_len_equal_axis_len(self):
        # GH16843
        # test ensures that index and rows keys are recognized correctly
