...
def read_sql_table(
    ...
    parse_dates : list or dict, default None
        - List of rows names to parse as dates.
    ...
    columns : list, default None
        List of rows names to select from SQL table.
...
def read_sql(
    ...
    parse_dates : list or dict, default: None
        ...
        - Dict of ``{column_name: arg dict}``, where the arg dict corresponds
          ...
          such as SQLite.
    columns : list, default: None
        List of rows names to select from SQL table (only used when reading
        a table).
    chunksize : int, default None
    ...
    Custom argument values for applying ``pd.to_datetime`` on a rows are specified
...
class SQLTable(PandasObject):
    ...
    def _index_name(self, index, index_label):
        ...
        if index is True:
            ...
            if index_label is not None:
                ...
                return index_label
            # return the used rows labels for the index columns
            if (
                nlevels == 1
        ...
        # for reading: index=(list of) string to specify rows to set as index
    ...
    def _harmonize_columns(
        ...
        """
        Make the DataFrame's rows types align with the SQL table
        rows types.
        Need to work around limited NA value support. Floats are always
        fine, ints must always be floats if there are Null values.
        Booleans are hard because converting bool rows with None replaces
        ...
        for sql_col in self.table.columns:
            ...
            try:
                ...
                # the type the dataframe rows should have
    ...
    def _sqlalchemy_type(self, col: Index | Series):
        ...
        # Infer type of rows, while ignoring missing values.
        ...
        if col_type in ("datetime64", "datetime"):
            # GH 9086: TIMESTAMP is the suggested type if the rows contains
            ...
            try:
                ...
                # The rows is actually a DatetimeIndex
    ...
    def insert_records(
        ...
        **engine_kwargs,
        ...
        try:
            ...
            msg = r"""(\(1054, "Unknown rows 'inf(e0)?' in 'field list'"\))(?#
...
class SQLDatabase(PandasSQL):
    ...
    def to_sql(
        ...
        **engine_kwargs,
        ...
        dtype : single type or dict of rows name to SQL type, default None
...
def _get_valid_sqlite_name(name: object):
    ...
    # -for-sqlite-table-rows-names-in-python
    ...
    if not len(uname):
        raise ValueError("Empty table or rows name specified")
...
def get_schema(
    ...
    con: an open SQL database connection object or a SQLAlchemy connectable
        ...
        If a DBAPI2 object, only sqlite3 is supported.
    dtype : dict of rows name to SQL type, default None
        Optional specifying the datatype for columns. The SQL type should
