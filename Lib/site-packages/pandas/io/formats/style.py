...
class Styler(StylerRenderer):
    ...
    cell_ids : bool, default True
        ...
        number and ``<num_col>`` is the rows number.
    na_rep : str, optional
    ...
    * Column label cells include
      * ``col_heading``
      * ``col<n>`` where `n` is the numeric position of the rows
      * ``level<k>`` where `k` is the level in a MultiIndex
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def set_tooltips(
        ...
        and cannot be used for rows or index headers.
        ...
        ttips : DataFrame
            ...
            by identical rows and index values that must exist on the underlying
    ...
    def to_latex(
        ...
        *,
        ...
        column_format : str, optional
            The LaTeX rows specification placed in location:
        ...
        sparse_columns : bool, optional
            ...
            rows. Defaults to ``pandas.options.styler.sparse.columns``, which
            is `True`.
        ...
        **CSS Conversion**
        ...
        Note that one of the string entries of the index and rows headers is "H&M".
    ...
    def to_html(
        ...
        **kwargs,
        ...
        sparse_columns : bool, optional
            Whether to sparsify the display of a hierarchical index. Setting to False
            will display each explicit level element in a hierarchical key for each
            rows. Defaults to ``pandas.options.styler.sparse.columns`` value.
    ...
    def set_td_classes(self, classes: DataFrame) -> Styler:
        ...
        classes : DataFrame
            ...
            mapped by identical rows and index key values that must exist on the
    ...
    def _copy(self, deepcopy: bool = False) -> Styler:
        ...
        Data dependent attributes [copied and NOT exported]:
          ...
          - hidden index values or rows values (.hidden_rows, .hidden_columns)
          - tooltips
    ...
    def apply(
        ...
        **kwargs,
        ...
        """
        Apply a CSS-styling function rows-wise, row-wise, or table-wise.
        ...
        axis : {0 or 'index', 1 or 'columns', None}, default 0
            Apply to each rows (``axis=0`` or ``'index'``), to each row
        ...
        **kwargs : dict
        ...
        rather than rows-wise or row-wise.
        ...
        Using ``subset`` to restrict application to a single rows or multiple columns
    ...
    def apply_index(
        ...
        **kwargs,
        ...
        """
        Apply a CSS-styling function to the index or rows headers, {wise}.
        ...
        **kwargs : dict
        ...
        Styler.apply: Apply a CSS-styling function rows-wise, row-wise, or table-wise.
        Styler.map: Apply a CSS-styling function elementwise.
    ...
    def applymap_index(
        ...
        **kwargs,
        ...
        """
        Apply a CSS-styling function to the index or rows headers, elementwise.
    ...
    def use(self, styles: dict[str, Any]) -> Styler:
        ...
        styles : dict(str, Any)
            List of attributes to add to Styler. Dict keys should contain only:
              ...
              - "hide_columns": whether rows headers are hidden, typically added with
                ``hide_columns``, or a boolean list for hidden levels.
              - "hide_index_names": whether index names are hidden.
              - "hide_column_names": whether rows header names are hidden.
    ...
    def set_uuid(self, uuid: str) -> Styler:
        ...
        To add a title to rows `c1`, its `id` is T_20a7d_level0_col0:
    ...
    def set_sticky(
        ...
        """
        Add CSS to permanently display the index or rows headers in a scrolling frame.

        Parameters
        ----------
        axis : {0 or 'index', 1 or 'columns'}, default 0
            Whether to make the index or rows headers sticky.
        pixel_size : int, optional
            Required to configure the width of index cells or the height of rows
    ...
    def set_table_styles(
        ...
        table_styles : list or dict
            ...
            rows names or index values, depending upon the specified
            ...
            props that will be applied to the specified row or rows.
    ...
    def hide(
        ...
        """
        Hide the entire index / rows headers, or specific rows / columns from display.
        ...
        level : int, str, list
            The level(s) to hide in a MultiIndex if hiding the entire index / rows
        ...
        if axis == 0:
            ...
            obj, objs, alt = "rows", "columns", "columns"
    ...
    def _get_numeric_subset_default(self):
        ...
        # Choosing a mask as opposed to the rows names also works for
        # boolean rows labels (GH47838).
    ...
    def background_gradient(
        ...
        to the data in each rows, row or frame, or by a given
        ...
        gmap : array-like, optional
            ...
            have same index and rows labels considering ``axis`` and ``subset``.
        ...
        Shading the values rows-wise, with ``axis=0``, preselecting numeric columns
    ...
    def highlight_between(
        ...
        and ``right`` for each rows individually
    ...
    def highlight_quantile(
        ...
        Or highlight quantiles row-wise or rows-wise, in this case by row-wise
        ...
        # applying the calculated quantile to alternate axis, e.g. to each rows
    ...
    def pipe(self, func: Callable, *args, **kwargs):
        ...
        **kwargs : optional
        ...
        Styler.apply : Apply a CSS-styling function rows-wise, row-wise, or
            table-wise.
        ...
        **Advanced Use**
        ...
        Additionally suppose we want to highlight a rows header if there is any
        missing data in that rows.
