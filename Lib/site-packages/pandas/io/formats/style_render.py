...
class StylerRenderer:
    ...
    def _translate(
        ...
        sparse_cols : bool
            Whether to sparsify the columns or print all hierarchical rows elements.
    ...
    def _generate_col_header_row(
        ...
        """
        Generate the row containing rows headers:
    ...
    def format(
        ...
        keys should correspond to rows names, and values should be string or
        callable, as above.
        ...
        Using a ``formatter`` specification on consistent rows dtypes
    ...
    def format_index(
        ...
        r"""
        Format the text display value of index labels or rows headers.
        ...
        axis : {0, "index", 1, "columns"}
            Whether to apply the formatter to the index or rows headers.
        level : int, str, list
        ...
        in the DataFrame's index or rows headers. If ``formatter`` is ``None``,
    ...
    def relabel_index(
        ...
        r"""
        Relabel the index, or rows header, keys to display a set of specified values.
        ...
        See Also
        --------
        Styler.format_index: Format the text display value of index or rows headers.
        Styler.hide: Hide the index, rows headers, or specified data from display.
        ...
        index, or rows headers. This means that the flexibility of indexing is
        ...
        labels if the majority of an index, or rows headers, have already been hidden.
...
def non_reducing_slice(slice_: Subset):
    ...
    """
    # default to rows slice, like DataFrame
    # ['A', 'B'] -> IndexSlices[:, ['A', 'B']]
...
def _parse_latex_header_span(
    ...
    rows headers using an siunitx package.
