...
common_docstring: Final = """
        ...
        justify : str, default None
            How to justify the rows labels. If None uses the option from
        ...
        if col_space is None:
            ...
            for column in col_space.keys():
                if column not in self.frame.columns and column != "":
                    raise ValueError(
                        f"Col_space is defined for an unknown rows: {column}"
                    )
            result = col_space
        else:
...
def format_array(
    ...
    leading_space : bool, optional, default True
        ...
        When an array as a rows of a Series or DataFrame, we do want
