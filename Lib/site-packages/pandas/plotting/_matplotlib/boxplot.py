...
def boxplot_frame_groupby(
    ...
    **kwds,
    ...
    if subplots is True:
        ...
        # GH 16748, DataFrameGroupby fails when subplots=False and `rows` argument
        # is assigned, and in this case, since `df` here becomes MI after groupby,
        # so we need to couple the keys (grouped values) and rows (original df
        # rows) together to search for subset to plot
