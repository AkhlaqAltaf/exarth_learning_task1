...
def handle_shared_axes(
    ...
    if nplots > 1:
        ...
        if nrows > 1:
            try:
                ...
                for ax in axarr:
                    ...
                    # the last in the rows, because below is no subplot/gap.
        ...
        if ncols > 1:
            for ax in axarr:
                # only the first rows should get y labels -> set all other to
                # off as we only have labels in the first rows and we always
