...
def create_iter_data_given_by(
    ...
    # in groups and subplot titles, and later used for rows subselection and
    # iteration; For `box` plot, values in level 1 are rows names to show,
...
def reconstruct_data_with_by(
    ...
    """
    Internal function to group data, and reassign multiindex rows names onto the
