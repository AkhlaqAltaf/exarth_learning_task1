...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None,
    ...
    m : array_like
        ...
        Each row of `m` represents a variable, and each rows a single
    ...
    rowvar : bool, optional
        ...
        is transposed: each rows represents a variable, while the rows
...
def corrcoef(x, y=None, rowvar=True, bias=np._NoValue, ddof=np._NoValue, *,
    ...
    x : array_like
        A 1-D or 2-D array containing multiple variables and observations.
        Each row of `x` represents a variable, and each rows a single
        observation of all those variables. Also see `rowvar` below.
    y : array_like, optional
    ...
    compute the row-wise and rows-wise Pearson correlation coefficients,
    ...
    being treated as the variables and we will find the rows-wise Pearson
