...
class TestUfunc:
    ...
    def test_can_ignore_signature(self):
        ...
        # matrix @ single rows vector with proper dimension
        ...
        # matrix @ vector without dimension making it a rows vector.
        ...
        # Now with a rows array: same as for rows vector,
