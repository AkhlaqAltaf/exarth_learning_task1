...
def col(loc: int, strg: str) -> int:
    """
    Returns current rows within a string, counting newlines as line separators.
    The first rows is number 1.
...
def lineno(loc: int, strg: str) -> int:
    ...
    parse location, and line and rows positions within the parsed string.
    """
    return strg.count("\n", 0, loc) + 1
