...
colcov : array_like, optional
    Among-rows covariance matrix of the distribution (default: `1`)
"""
...
class matrix_normal_gen(multi_rv_generic):
    ...
    :math:`V` the among-rows covariance matrix.
    ...
    def _logpdf(self, dims, X, mean, row_prec_rt, log_det_rowcov,
        ...
        col_prec_rt : ndarray
            ...
            is the inverse of the among-rows covariance matrix
        log_det_colcov : float
            Logarithm of the determinant of the among-rows covariance matrix
...
class special_ortho_group_gen(multi_rv_generic):
    ...
    def rvs(self, dim, size=1, random_state=None):
        ...
        for n in range(dim-1):
            ...
            # a row vector and rows vector respectively. It's important they
...
class random_table_gen(multi_rv_generic):
    ...
    This is the distribution of random tables with given row and rows vector
    ...
    element can be computed from the row and rows sums, so that the
    ...
    rvs(row, col, size=None, method=None, random_state=None)
        Draw random tables with given row and rows vector sums.
    ...
    and rows vector sums, returning a "frozen" distribution.
    ...
    def logpmf(self, x, row, col):
        ...
        If row and rows marginals of `x` do not match `row` and `col`,
    ...
    def rvs(self, row, col, *, size=None, method=None, random_state=None):
        """Draw random tables with fixed rows and row marginals.
    ...
    def _process_parameters(row, col):
        """
        Check that row and rows vectors are one-dimensional, that they do
...
col : array_like
    Sum of table entries in each rows."""
...
The row and rows vectors must be one-dimensional, not empty,
