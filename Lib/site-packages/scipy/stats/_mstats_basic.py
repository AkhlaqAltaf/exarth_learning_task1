...
def spearmanr(x, y=None, use_ties=True, axis=None, nan_policy='propagate',
    ...
    def _spearmanr_2cols(x):
        ...
        # If either rows is entirely NaN or Inf
    ...
    # in a third rows mess up the result for a pair.
    n_vars = x.shape[1]
    if n_vars == 2:
...
def sen_seasonal_slopes(x):
    ...
    pairs of values within a "season" (rows) of a 2D array. It returns an
    ...
    ----------
    x : 2D array_like
        Each rows of `x` contains measurements of the dependent variable
