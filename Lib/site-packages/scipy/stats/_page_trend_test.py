...
def page_trend_test(data, ranked=False, predicted_ranks=None, method='auto'):
    ...
    * the observations are hypothesized to have a particular order.
    ...
    data : array-like
        ...
        rows :math:`j` is the observation corresponding with subject
    ...
    predicted_ranks : array-like, optional
        The predicted ranks of the rows means. If not specified,
    ...
    rows corresponding with tutorial rankings should be first; the seminar
    is hypothesized to have the highest ratings, so its rows should be last.
    ...
    We add the ranks within each rows, multiply the sums by the
