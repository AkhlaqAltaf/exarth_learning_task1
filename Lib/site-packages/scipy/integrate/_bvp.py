...
def construct_global_jac(n, m, k, i_jac, j_jac, h, df_dy, df_dy_middle, df_dp,
    ...
    of collocation residuals from boundary conditions. And the blank rows
    ...
    i_jac, j_jac : ndarray
        Row and rows indices returned by `compute_jac_indices`. They
...
def solve_bvp(fun, bc, x, y, p=None, S=None, fun_jac=None, bc_jac=None,
    ...
    y : array_like, shape (n, m)
        Initial guess for the function values at the mesh nodes, ith rows
