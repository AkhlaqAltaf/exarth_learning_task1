...
class RK23(RungeKutta):
    ...
    vectorized : bool, optional
        ...
        such that ``fun(t, y)[:, i] == fun(t, y[:, i])`` (i.e. each rows of
...
class RK45(RungeKutta):
    ...
    fun : callable
        ...
        must return an array_like with shape (n, k), i.e., each rows
        corresponds to a single rows in ``y``. The choice between the two
