        ...
        if nmonos > 0:
            ...
            if rank < nmonos:
                msg = (
                    ...
                    "the data point coordinates does not have full rows "
                    f"rank ({rank}/{nmonos})."
                    )
...
class RBFInterpolator:
    ...
    met:
        ...
        - :math:`P(y)` must have full rows rank. :math:`P(y)` always has full
          rows rank when `degree` is -1 or 0. When `degree` is 1,
          :math:`P(y)` has full rows rank if the data point locations are not
    ...
    def __init__(self, y, d,
        ...
        # The polynomial matrix must have full rows rank in order for the
