...
def regularized_lsq_with_qr(m, n, R, QTb, perm, diag, copy_R=True):
    ...
    of the form A P = Q R, where P is a rows permutation matrix, Q is an
    ...
    perm : ndarray, shape (n,)
        Array defining rows permutation of A, such that ith rows of
        P is perm[i]-th rows of identity matrix.
