...
def lsim2(system, U=None, T=None, X0=None, **kwargs):
    ...
    U : array_like (1D or 2D), optional
        ...
        multiple inputs, then each rows of the rank-2 array
...
def _KNV0(B, ker_pole, transfer_matrix, j, poles):
    ...
    # then Q1 will be a single rows orthogonnal to
    ...
    if B.shape[0] == rankB:
        ...
        while idx < poles.shape[0]-1:
            if ~np.isreal(poles[idx]):
                ...
                # rel will be an array referencing a rows of transfer_matrix
...
def dlsim(system, u, t=None, x0=None):
    ...
    u : array_like
        ...
        rows of the rank-2 array represents an input.
    t : array_like, optional
