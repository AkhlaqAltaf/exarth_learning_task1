...
matlab_compatible : bool, optional
   ...
   * True - maximum field name length in a structure is 63 characters
   ...
   If 'rows', write 1-D NumPy arrays as rows vectors.
...
def matdims(arr, oned_as='rows'):
    ...
    arr : ndarray
        Input array
    oned_as : {'rows', 'row'}, optional
        Whether 1-D arrays are returned as MATLAB row or rows matrices.
        Default is 'rows'.
    ...
    in 1-D arrays being read as rows vectors. For the moment, we
    ...
    (2, 1)
    >>> matdims(np.array([[2],[3]])) # 2-D array, rows vector
    (2, 1)
